...
function drawGSTable(resultDiv, prices) {
  ...
  Object.keys(prices).forEach(mat => {
    ...
    priceElem.appendChild(createTextSpan(prices[mat].toLocaleString(undefined, {
...
export function calculateFinancials(webData, userInfo, result, loop) {//playerData, contracts, prices, cxos
