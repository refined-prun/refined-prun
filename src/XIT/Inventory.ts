...
function FIOInv_post(tile, parameters, jsondata) {
  ...
  volumeLine.appendChild(createTextSpan(volumeUsed.toLocaleString(undefined, {
  ...
  weightLine.appendChild(createTextSpan(weightUsed.toLocaleString(undefined, {
    maximumFractionDigits: 2,
    minimumFractionDigits: 2
...
function fioMatsAlphabetSort(a, b) {
  if (!a["MaterialTicker"] || !b["MaterialTicker"] || !MaterialNames[a["MaterialTicker"]] || !MaterialNames[b["MaterialTicker"]]) {
    return 0;
  }
